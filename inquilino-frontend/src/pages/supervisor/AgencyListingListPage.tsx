...
export default function AgencyListingListPage() {
  ...
  useEffect(() => {
    setLoading(true)
    getSupervisorListingQueue(statuses, page, PAGE_SIZE, 'AGENCY')
      .then(setResult)
      .catch(console.error)
  ...
  return (
    <div className="w-full px-4 py-6">
      <h1 className="text-xl font-bold mb-5">Annunci Agenzie</h1>
        ...
        <>
          ...
          <div className="space-y-3">
            {listings.map(l => (
              <div
                key={l.id}
                onClick={() => navigate(`/supervisor/agency-listings/${l.id}`, { state: { backTo: '/supervisor/agency-listings' } })}
